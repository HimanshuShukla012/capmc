    ...
    >
      ...
      <div className="relative z-10 text-center mb-24">
        ...
        <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
          Discover the strategic advantages that position Dubai as the premier destination for international chartered accountancy practices and global business ventures
        </p>
      </div>
