...
const ContactPage = () => {
  return (
    <div className="bg-gradient-to-b from-gray-50 via-white to-gray-100 text-gray-800 scroll-smooth">
      ...
      <section className="min-h-screen bg-gradient-to-b from-white to-gray-50 text-gray-800 py-24 px-6 md:px-20 relative overflow-hidden">
        {/* SVG Background */}
        <svg
        ...
        <div className="relative z-10 top-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <h2 className="text-4xl md:text-5xl font-extrabold text-[#FF8C00]">
              Get in Touch
            </h2>
            ...
            <div className="space-y-6 text-gray-700 text-base leading-relaxed">
              <div>
                <span className="block text-[#FF8C00] font-semibold">Address:</span>
                701, Al Durrah Tower, Shaikh Zaid Road - Dubai - United Arab Emirates
              </div>
              <div>
                <span className="block text-[#FF8C00] font-semibold">Phone:</span>
                +971- 529283063<br/>
                +91-94154-27433
              </div>
              <div>
                <span className="block text-[#FF8C00] font-semibold">Email:</span>
                info@capmc.ae
              </div>
            </div>
          </div>
          ...
          {/* Contact Form */}
          <form className="space-y-6 bg-white/80 p-8 rounded-2xl backdrop-blur-lg border border-gray-200/60 shadow-xl">
            <div>
              <label className="block mb-2 text-sm font-medium text-gray-800">Full Name</label>
              <input
                type="text"
                placeholder="John Doe"
                className="w-full px-4 py-3 rounded-lg bg-gray-50/50 text-gray-800 placeholder-gray-500 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#FFB400] focus:border-transparent"
                required
              />
            </div>
            <div>
              <label className="block mb-2 text-sm font-medium text-gray-800">Email Address</label>
              <input
                type="email"
            ...
            <button
              type="submit"
              className="bg-[#FF8C00] text-white font-semibold px-6 py-3 rounded-full hover:bg-[#e67e00] transition duration-300 shadow-lg"
            >
              Send Message →
            </button>
          </form>
     ...
     {/* Location Section - Premium Layout with Light Theme */}
<section className="relative bg-gray-50 text-gray-800 px-6 md:px-20 py-32 overflow-hidden">
  ...
  <div className="relative z-20 grid md:grid-cols-2 gap-12 max-w-7xl mx-auto items-center">
    ...
    {/* Map */}
    <div className="overflow-hidden rounded-3xl border border-gray-200/60 bg-white/80 backdrop-blur-md shadow-xl ring-1 ring-gray-100/50">
      <iframe
    ...
    <div className="space-y-6">
      <h3 className="text-4xl md:text-5xl font-extrabold text-[#FF8C00] drop-shadow-[0_0_30px_rgba(255,140,0,0.2)]">
        Visit Us
      </h3>
